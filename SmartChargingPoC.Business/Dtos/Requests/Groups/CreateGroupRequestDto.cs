...
public class CreateGroupRequestDto : RequestDtoBase
{
    ...
    [DoubleGreaterThan(ApiConstants.General.MinCapacityInAmpsValue, ErrorMessage = ApiConstants.ErrorMessage.GreaterThan)]
